document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        ...
        vn: {
            ...
            nav_home: "Trang chủ",
            nav_schedule: "Đặt lịch hẹn",
            nav_contact: "Liên hệ chúng tôi",
            nav_patient_register: "Đăng ký cho khách hàng",
            nav_doctor_register: "Đăng ký cho bác sĩ",
            nav_patient_login: "Đăng nhập cho khách hàng",
            nav_doctor_login: "Đăng nhập cho bác sĩ",
            nav_prescriptions: "Đơn thuốc",
            nav_lab_results: "Kết quả xét nghiệm",
            footer_text: "CS 3300 Nền Tảng Chăm sóc sức khỏe",
            name_placeholder: "Tên",
            email_placeholder: "Email",
            message_placeholder: "Tin nhắn",
            register: "Đăng ký",
            login: "Đăng nhập",
            schedule_title: "Đặt lịch hẹn",
            schedule_date: "Ngày hẹn",
            schedule_time: "Thời gian hẹn",
            schedule_doctor: "Chọn bác sĩ",
            schedule_select_doctor: "Chọn bác sĩ",
            schedule_Dr_Aziz: "Dr. Aziz",
            schedule_Dr_Nick: "Dr. Nick",
            schedule_Dr_Trung: "Dr. Trung",
            schedule_payment_method: "Phương thức thanh toán",
            schedule_select_payment: "Chọn phương thức thanh toán",
            schedule_credit_card: "Thẻ tín dụng",
            schedule_paypal: "PayPal",
            schedule_card_details: "Thông tin thẻ",
            schedule_appointment: "Đặt lịch hẹn ($30)",
            register_title: "Đăng ký bác sĩ",
            register_first_name: "Tên",
            register_last_name: "Họ",
            register_email: "Email",
            register_password: "Mật khẩu",
            register_button: "Đăng ký",
            prescriptions_title: "Đơn thuốc",
            prescriptions_medication: "Thuốc",
            prescriptions_dosage: "Liều lượng",
            prescriptions_frequency: "Tần suất",
            prescriptions_start_date: "Ngày bắt đầu",
            prescriptions_end_date: "Ngày kết thúc",
            contact_name: "Tên",
            contact_email: "Email",
            contact_message: "Tin nhắn",
            contact_send_message: "Gửi tin nhắn",
            lab_results_title: "Kết quả xét nghiệm - CS 3300 Nền Tảng Chăm sóc sức khỏe",
            lab_results_heading: "Kết quả xét nghiệm",
            result_id: "ID Kết quả",
            patient_name: "Tên khách hàng",
            test: "Kiểm tra",
            result: "Kết quả",
            date: "Ngày",
            cholesterol_test: "Kiểm tra cholesterol",
            glucose_test: "Kiểm tra Glucose",
            cbc_test: "Công thức máu toàn bộ (CBC)",
            cholesterol_normal: "Tổng Cholesterol: 180 mg/dL (Bìnht thường)",
            glucose_high: "Glucose trong máu: 140 mg/dL (Cao)",
            cbc_normal: "WBC: 6,000 /μL (Bình thường)",
            hero_title: "Chào mừng đến với Nền Tảng Chăm sóc sức khỏe",
            hero_description: "Giải pháp toàn diện của bạn để quản lý cuộc hẹn, thanh toán và hồ sơ sức khỏe",
            get_started: "Bắt đầu",
            features_title: "Tính năng",
            features_description: "Khám phá những lợi ích của việc sử dụng nền tảng của chúng tôi",
            features_appointments_title: "Đặt hẹn dễ dàng",
            features_appointments_description: "Lên lịch các cuộc hẹn của bạn một cách dễ dàng và thuận tiện.",
            features_payments_title: "Thanh toán an toàn",
            features_payments_description: "Yên tâm thực hiện thanh toán an toàn thông qua nền tảng của chúng tôi.",
            features_records_title: "Hồ sơ sức khỏe",
            features_records_description: "Truy cập và quản lý hồ sơ sức khỏe của bạn mọi lúc, mọi nơi.",
            testimonials_title: "Lời chứng thực",
            testimonials_description: "Hãy nghe người dùng của chúng tôi nói gì",
            testimonial_1: "Nền tảng này đã giúp việc quản lý sức khỏe của tôi trở nên dễ dàng hơn rất nhiều!",
            testimonial_author_1: "John Doe",
            testimonial_2: "Một công cụ thay đổi cuộc chơi để quản lý chăm sóc sức khỏe.",
            testimonial_author_2: "Jane Smith",
            contact_title: "Liên hệ chúng tôi",
            contact_description: "Nếu bạn có bất kỳ câu hỏi nào, hãy liên hệ với chúng tôi!"
        }
    };
